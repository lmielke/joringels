...
def main(*args, **kwargs):
    ...
    msg = (
        f"upload / upload_all: extract keepass kdb secrets and upload to server:\n"
    ...
    print(f"to see available keepass entries: python -m joringels.src.sources.keepass show")
